import {ADD_LAST_20_MESSAGES,  ADD_ERROR, ADD_NEW_MESSAGES, SET_FRIEND_ID,  ADD_10_PREVIOUS_MESSAGES, START_FETCHING_20_LAST_MESSAGES, STOP_FETCHING_20_LAST_MESSAGES, STOP_FETCHING_10_PREVIOUS_MESSAGES, START_FETCHING_10_PREVIOUS_MESSAGES} from "./types"
import {Message} from "./interfaces"
import firebase from "../../global_components/firebase"
import { AppThunk } from "../store";


export const fetchLast20Messages = (friendID: string):AppThunk => async (dispatch) => {
    ...
    try{
        ...
        firebase.listenForNewMessages((messages:Message[]) => dispatch(addNewMessages(messages)), friendID);
    }
} 
...
export const sendMessage = (message:string, friendID:string):AppThunk => async (dispatch) => {
